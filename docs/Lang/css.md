...
## `Animate.css` for Easy CSS Animation
...
## SVG Backgrounds Via CSS to Save on Image Loading

Home <https://www.svgbackgrounds.com/>

Customize and apply backgrounds fast !

Create stunning websites easily with full screen graphics under 5KB -
